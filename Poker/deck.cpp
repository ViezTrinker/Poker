...
{{
	...
	{ Cards::FiveClubs,		Suit::Diamonds, Rank::Five },
	{ Cards::FiveClubs,		Suit::Hearts,	Rank::Five },
	{ Cards::FiveClubs,		Suit::Spades,	Rank::Five },

	{ Cards::SixClubs,		Suit::Clubs,	Rank::Six },
	{ Cards::SixClubs,		Suit::Diamonds, Rank::Six },
	{ Cards::SixClubs,		Suit::Hearts,	Rank::Six },
	{ Cards::SixClubs,		Suit::Spades,	Rank::Six },

	{ Cards::SevenClubs,	Suit::Clubs,	Rank::Seven },
	{ Cards::SevenClubs,	Suit::Diamonds, Rank::Seven },
	{ Cards::SevenClubs,	Suit::Hearts,	Rank::Seven },
	{ Cards::SevenClubs,	Suit::Spades,	Rank::Seven },

	{ Cards::EightClubs,	Suit::Clubs,	Rank::Eight },
	{ Cards::EightClubs,	Suit::Diamonds, Rank::Eight },
	{ Cards::EightClubs,	Suit::Hearts,	Rank::Eight },
	{ Cards::EightClubs,	Suit::Spades,	Rank::Eight },

	{ Cards::NineClubs,		Suit::Clubs,	Rank::Nine },
	{ Cards::NineClubs,		Suit::Diamonds, Rank::Nine },
	{ Cards::NineClubs,		Suit::Hearts,	Rank::Nine },
	{ Cards::NineClubs,		Suit::Spades,	Rank::Nine },

	{ Cards::TenClubs,		Suit::Clubs,	Rank::Ten },
	{ Cards::TenClubs,		Suit::Diamonds, Rank::Ten },
	{ Cards::TenClubs,		Suit::Hearts,	Rank::Ten },
	{ Cards::TenClubs,		Suit::Spades,	Rank::Ten },

	{ Cards::JackClubs,		Suit::Clubs,	Rank::Jack },
	{ Cards::JackClubs,		Suit::Diamonds, Rank::Jack },
	{ Cards::JackClubs,		Suit::Hearts,	Rank::Jack },
	{ Cards::JackClubs,		Suit::Spades,	Rank::Jack },

	{ Cards::QueenClubs,	Suit::Clubs,	Rank::Queen },
	{ Cards::QueenClubs,	Suit::Diamonds, Rank::Queen },
	{ Cards::QueenClubs,	Suit::Hearts,	Rank::Queen },
	{ Cards::QueenClubs,	Suit::Spades,	Rank::Queen },

	{ Cards::KingClubs,		Suit::Clubs,	Rank::King },
	{ Cards::KingClubs,		Suit::Diamonds, Rank::King },
	{ Cards::KingClubs,		Suit::Hearts,	Rank::King },
	{ Cards::KingClubs,		Suit::Spades,	Rank::King },

	{ Cards::AceClubs,		Suit::Clubs,	Rank::Ace },
	{ Cards::AceClubs,		Suit::Diamonds, Rank::Ace },
	{ Cards::AceClubs,		Suit::Hearts,	Rank::Ace },
	{ Cards::AceClubs,		Suit::Spades,	Rank::Ace },
}};
